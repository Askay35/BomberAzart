<template>
  <header>
    ...
    <Modal id="deposite_modal" ref="deposite_modal">
      <template #header>
        <div class="modal-header-title">Пополнение</div>

        <svg
          id="deposite-close"
          role="button"
          @click="hideModal($refs.deposite_modal)"
          width="22"
          height="22"
          viewBox="0 0 22 22"
          fill="none"
        ...
        >
          <rect width="22" height="22" rx="3" fill="#CDCECE" />
          <path
            d="M12.4874 11L15.8537 7.6338C16.0484 7.43912 16.0484 7.12319 15.8537 6.92819L15.0715 6.14601C14.8768 5.95133 14.5608 5.95133 14.3658 6.14601L10.9998 9.51252L7.63354 6.14633C7.43885 5.95164 7.12291 5.95164 6.92791 6.14633L6.14602 6.92819C5.95133 7.12287 5.95133 7.43881 6.14602 7.6338L9.51232 11L6.14602 14.3662C5.95133 14.5609 5.95133 14.8768 6.14602 15.0718L6.92822 15.854C7.12291 16.0487 7.43885 16.0487 7.63385 15.854L10.9998 12.4875L14.3661 15.8537C14.5608 16.0484 14.8768 16.0484 15.0718 15.8537L15.854 15.0715C16.0487 14.8768 16.0487 14.5609 15.854 14.3659L12.4874 11Z"
            fill="#A0A0A0"
          />
        </svg>
      </template>
      <template #body>
        <div id="deposite-pay-systems" class="prevent-select-all">
          <div
            class="pay-system-card pt-1"
            @click="current_system = 1"
            :class="{ active: current_system == 1 }"
          >
            <svg
              class="pay-system-icon"
              width="94"
              height="25"
              viewBox="0 0 94 25"
              fill="none"
            ...
            <div class="pay-system-name">Перевод с карты</div>
          </div>
          <div
            class="pay-system-card"
            @click="current_system = 2"
            :class="{ active: current_system == 2 }"
          >
            <img
              src="/src/assets/images/qiwi.svg"
              class="pay-system-icon ps-icon-color ps-icon-qiwi"
            />
            <svg
              viewBox="0 0 31 32"
              fill="none"
              ...
              aria-hidden="true"
              role="img"
              class="pay-system-icon ps-icon-mono ps-icon-qiwi"
            >
              <path
                fill="#fff"
                d="M14.24 0c7.85 0 14.238 6.345 14.238 14.236 0 2.672-.71 5.177-2.003 7.305-.043.085-.168.043-.168-.04-.501-3.508-2.63-5.47-5.762-6.013-.25-.04-.335-.208.041-.25.961-.084 2.338-.084 3.007.042.042-.333.042-.71.042-1.086a9.425 9.425 0 00-9.437-9.434 9.425 9.425 0 00-9.437 9.434 9.426 9.426 0 009.437 9.435h.46l-.065-.393a10.949 10.949 0 01-.103-2.153c.042-.585.168-.668.417-.209 1.295 2.253 3.174 4.3 6.807 5.094 2.964.666 5.971 1.46 9.187 5.51.292.333-.125.71-.46.417-3.298-2.922-6.264-3.84-8.976-3.84-3.049 0-5.096.418-7.226.418C6.39 28.473 0 22.084 0 14.236S6.347 0 14.24 0zm7.265 22.46c.335.043.71.167 1.002.418.626.542.836 1.168.501 1.628-.166.25-.501.376-.834.376-.376 0-.71-.125-.961-.334-.584-.502-.752-1.336-.375-1.796a.907.907 0 01.667-.292zm3.132-2.296c.542.209.752 1.002.793 1.377.084.628-.083.877-.292.877-.21 0-.501-.25-.793-.751-.334-.5-.417-1.044-.292-1.335.083-.21.333-.294.584-.167v-.001z"
                class="qiwi_svg__mono"
              ></path>
              <path
                fill="url(#qiwi_svg__a)"
                d="M14.24 0c7.85 0 14.238 6.345 14.238 14.236 0 2.672-.71 5.177-2.003 7.305-.043.085-.168.043-.168-.04-.501-3.508-2.63-5.47-5.762-6.013-.25-.04-.335-.208.041-.25.961-.084 2.338-.084 3.007.042.042-.333.042-.71.042-1.086a9.425 9.425 0 00-9.437-9.434 9.425 9.425 0 00-9.437 9.434 9.426 9.426 0 009.437 9.435h.46l-.065-.393a10.949 10.949 0 01-.103-2.153c.042-.585.168-.668.417-.209 1.295 2.253 3.174 4.3 6.807 5.094 2.964.666 5.971 1.46 9.187 5.51.292.333-.125.71-.46.417-3.298-2.922-6.264-3.84-8.976-3.84-3.049 0-5.096.418-7.226.418C6.39 28.473 0 22.084 0 14.236S6.347 0 14.24 0zm7.265 22.46c.335.043.71.167 1.002.418.626.542.836 1.168.501 1.628-.166.25-.501.376-.834.376-.376 0-.71-.125-.961-.334-.584-.502-.752-1.336-.375-1.796a.907.907 0 01.667-.292zm3.132-2.296c.542.209.752 1.002.793 1.377.084.628-.083.877-.292.877-.21 0-.501-.25-.793-.751-.334-.5-.417-1.044-.292-1.335.083-.21.333-.294.584-.167v-.001z"
                class="qiwi_svg__color"
              ></path>
            </svg>
            <div class="pay-system-name">QIWI</div>
          </div>
          <div class="pay-system-card disabled">
            <img src="/src/assets/images/ymoney.svg" class="pay-system-icon" />
            <div class="pay-system-name">ЮMoney</div>
          </div>
          <div class="pay-system-card pt-1 disabled">
            <img src="/src/assets/images/visa.svg" class="pay-system-icon" />
            <div class="pay-system-name">Перевод с карты</div>
          </div>
        </div>
        <sber-form v-show="current_system == 1" />
...
<script>
import SberForm from "./Deposite/SberForm.vue";
import QiwiForm from "./Deposite/QiwiForm.vue";
...
.pay-system-card {
  ...
  &.active {
    box-shadow: 0 6px 18px 0 rgba(17, 120, 223, 0.3);
    ...
    color: #ffffffb3;
    background-image: linear-gradient(129deg, var(--pink-color) -19%, var(--ui-elem-bg) 149%);
  }
  cursor: pointer;
  * {
    pointer-events: none;
